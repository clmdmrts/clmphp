    ...
    <div class="container">
        <form method="post" class="form-row" enctype="multipart/form-data">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <select name="reklamalani" class="form-control">
                        ...
                        <option value="Yazı İçi">Yazı İçi</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success" name="reklambutonu">Düzenle</button>
                </div>
            </div>
        </form>
    </div>
</section>
<!-- Reklam Düzenleme End -->
<br>
                    ...
                    if(isset($_POST['reklambutonu'])){
                        ...
                        if (move_uploaded_file($_FILES['gorsel']['tmp_name'], $yuklenecekfoto)) {
                            ...
                            if ($sorgu_rekduzenle ->rowCount()) {
                                echo '<div class="alert alert-success text-center">Kayıt Düzenlendi</div>';
                                echo '<meta http-equiv="refresh" content="1; url=reklamduzenle.php?id='.$id.';">';
                            } else {
